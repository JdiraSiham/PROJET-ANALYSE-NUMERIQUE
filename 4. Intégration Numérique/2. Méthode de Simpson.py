...
# Données (identiques à celles que tu as données) 
...
dI_dt.append(val) 
# Intégration avec la méthode de Simpson 
Itotal_simpson = simpson(dI_dt, dx=10) 
print("Nombre total estimé de personnes infectées (méthode de 
Simpson) :", int(Itotal_simpson)) 
# Affichage 
